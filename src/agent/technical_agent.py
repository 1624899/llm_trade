...
6. 用中期持有视角区分“正常回踩”和“趋势失效”：只要中期趋势、量能结构和关键支撑未破，不要因为短期波动直接否定；但若 MA20/平台/ATR 止损被有效跌破，或出现放量滞涨与基本面风险共振，要明确建议减仓或清仓。
7. 必须区分“20日支撑”和“20日平台硬退出失效价”：收盘跌破20日支撑但尚未跌破硬退出失效价时，只能写成支撑承压/等待确认；只有跌破硬退出失效价、ATR止损或量化风险标签出现时，才写触发清仓。
